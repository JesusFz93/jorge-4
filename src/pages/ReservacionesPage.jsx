    ...
    <>
      ...
      <div className="row-col">
        <p style={{ color: "var(--color2)" }}>
          Hacer una reservación en Los Rosales te garantiza una mesa en nuestro
          acogedor comedor, permitiéndote disfrutar de una experiencia
          gastronómica sin igual sin la espera. Benefíciate de nuestro servicio
          personalizado y asegúrate de que tus ocasiones especiales sean
          memorables. Recomendamos reservar con anticipación, especialmente para
          cenas de fin de semana, festividades y eventos especiales.
        </p>
      </div>
      <div className="row-col">
        ...
        <div>
          <p className="text-center" style={{ color: "var(--color2)" }}>
            Para grupos grandes o eventos privados, por favor contáctanos
            directamente.
          </p>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-12 text-start">
          <h4 style={{ color: "var(--color3)" }}>
            Realiza tu Reservación Aquí
          </h4>
        </div>
        <div className="col">
          <form className="mt-3" onSubmit={enviarFormulario}>
            ...
            <div className="d-grid">
              <button type="submit" className="btn botonReservacion">
                Enviar Reservación
              </button>
            </div>
          </form>
